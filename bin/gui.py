...
def generator(class_combobox):
    # generator for making names of given class
    def instance_generator(class_type, num_instances):
    ...
    return {'class_name': class_input, 'instances': instance_generator(class_type, num_instances)}
